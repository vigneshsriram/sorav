...
router.post("/restaurant/:id", async (req, res) => {
  ...
  // console.log(authUser+"THAT")
   await recipeData.addreview(authUser,req.body.comment,onerest,req.body.rating);
...
router.post("/restaurantlist", async (req, res) => {
 ...
 //var cityValue = city.value;
  // var stateValue = state.value;
   ...
   if(state == ""){
    res.render("restaurant/restaurant_filter",{"message":"Enter State"})
     return;
   }
  
   if(city == ""){
    res.render("restaurant/restaurant_filter",{"message":"Enter City"})
    return;
   }
